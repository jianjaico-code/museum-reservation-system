					...
					<div class="card-body bg-light">
						...
						<form method="post">
							<div class="input-group mb-4">
								<p class="lead  ">Please enter your email or phone number to search for your account.</p>
								<div class="input-group-prepend">
									<span class="input-group-text"><i class="fa fa-user bigicon"></i></span>
								</div>
								<input id="fname" name="name" type="text" placeholder="Email" class="form-control" required="">
							</div>
						</div>
						<div class="card-footer bg-transparent text-center">
							<input type="submit" class="btn btn-success text-white btn-block" value="Search" name="proceed" >
						</form>
					</div>
				</div>
			</div>
